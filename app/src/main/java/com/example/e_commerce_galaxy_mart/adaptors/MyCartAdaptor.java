...
public class MyCartAdaptor extends RecyclerView.Adapter<MyCartAdaptor.ViewHolder> {
    ...
    @NonNull
    @Override
    public MyCartAdaptor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.my_cart_item,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull MyCartAdaptor.ViewHolder holder, int position) {
